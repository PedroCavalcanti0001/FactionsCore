...
import inv.content.InventoryContents;
import inv.opener.ChestInventoryOpener;
import inv.opener.InventoryOpener;
import inv.opener.SpecialInventoryOpener;
...
public class InventoryManager {
    ...
    class InvListener implements Listener {
        ...
        public void onInventoryClick(InventoryClickEvent e) {
            ...
            if (e.getClickedInventory() == null && !inv.isSkipOtherClickLocations()) {
                e.setCancelled(true);
                return;
            }
            if (e.getClickedInventory() == p.getOpenInventory().getTopInventory()) {
                ...
                if (inv.isSkipOtherClickLocations()) {
                    if (row < 0 || column < 0)
                        return;
